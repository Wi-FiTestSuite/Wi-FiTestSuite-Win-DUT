...
REG ADD HKEY_LOCAL_MACHINE\%myOutput% /v FragmentationThreshold /t REG_DWORD /d %4% /f
...
echo: syntax Error
echo:
echo:Example = Try - "SET_FRAG /interface <interface name> /action <Value>"
echo:
