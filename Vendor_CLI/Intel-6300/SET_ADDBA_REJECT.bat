...
REG ADD HKEY_LOCAL_MACHINE\%myOutput% /v rxAddbaDisable /t REG_DWORD /d %flag% /f
...
echo: syntax Error
echo:
echo:Example = Try - "SET_ADDBA_REJECT /interface <interface name> /action <Enable/Disable> [/NoDisable]"
echo:
