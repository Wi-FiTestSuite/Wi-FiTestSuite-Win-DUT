...
REG ADD HKEY_LOCAL_MACHINE\%myOutput% /v GreenFieldCapable /t REG_DWORD /d %flag% /f
...
echo: syntax Error
echo:
echo:Example = Try - "SET_GREENFIELD /interface <interface name> /action <Enable/Disable> [/NoDisable]"
echo:
...
:Success
echo:
echo:Greenfield capability is now %4%
echo: 
