...
:CheckActionValue
if /I (%4)==(Enable) Set val=1
if /I (%4)==(Disable) Set val=0
...
REG ADD HKEY_LOCAL_MACHINE\%myOutput% /v ShortGICapabilities /t REG_DWORD /d %val% /f
...
echo: syntax Error
echo:
echo:Example = Try - "SET_SGI20 /interface <interface name> /action <Enable/Disable> [/NoDisable]"
echo:
