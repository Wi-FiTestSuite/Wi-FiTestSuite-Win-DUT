...
#define WFA_TRAFFIC_AGENT_VERSION_TLV       (WFA_STA_SET_POWER_SAVE_TLV + 0x01)
#define WFA_STA_CLI_CMD_TLV					(WFA_TRAFFIC_AGENT_VERSION_TLV + 0x01)    /* 271 */
...
#define WFA_TRAFFIC_AGENT_VERSION_RESP_TLV  (WFA_STA_SET_POWER_SAVE_RESP_TLV + 0x01)
#define WFA_STA_CLI_CMD_RESP_TLV			(WFA_TRAFFIC_AGENT_VERSION_RESP_TLV + 0x01)        /* 528 */
